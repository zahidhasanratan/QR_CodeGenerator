        ...
        <div class="container">
            ...
            <div class="login-form">
                <div class="main-div2">
                    ...
                    <form method="POST" action="{{ route('otppassword.update') }}">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-12">
                                ...
                                <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="ie: subscriber@gmail.com" value="{{$useremail = \App\Models\User::where(['mobile' => $user->mobile])->first()->email}}" required autocomplete="email" autofocus>
                                @error('email')
