...
@section('title')
    <title>Money Receipt | Subscriber | Women & e-Commerce</title>
@endsection
                        ...
                        <div style="padding:10px 15px;">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                    ...
                                    <p>
                                        <em>Receipt : #SPF{{$subscription_fees_submit->id}}</em>
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <a target="_blank" href="{{ route('receiptview',$subscription_fees_submit->id) }}" class="btn btn-success btn-lg btn-block">
