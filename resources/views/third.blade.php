                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="wizard">
                                <div class="wizard-inner">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation" class="@if(($subscriber->step1)==1 and ($subscriber->step2)==1) active @else disabled @endif">
                            ...
                            <form method="POST" action="{{route('third-form',$subscriber->subscriber_id)}}">
                                    @csrf
                                <div class="tab-pane @if(($subscriber->step3)==1 and ($subscriber->step2)==1) active @else @endif" role="tabpanel" id="step3">
                                        ...
                                        <fieldset class="col-lg-12 border border-primary p-3 mb-3">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-6">
                                                    ...
                                                    <input name="joining_date" type="text" class="form-control"
                                                    >
                                                </div>
