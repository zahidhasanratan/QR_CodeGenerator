      ...
      -->
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="details-family.html">
                        <i class="material-icons">language</i>
                        <p>Details of Family </p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="income-tax.html">
                        <i class="material-icons">language</i>
                        <p>Detail of Income & Income Tax</p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="company-info.html">
                        <i class="material-icons">language</i>
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="upload-logo.html">
                        <i class="material-icons">language</i>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">Subscriber Dashboard</a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <div class="copyright float-left">
                            <p>Copyright © 2020 Women &amp; e-Commerce</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <div class="copyright float-right">
                            <p><a href="https://esoft.com.bd/" target="_blank">Developed by </a> e-Soft</p>
                        </div>
                    </div>
                </div>
            </div>
