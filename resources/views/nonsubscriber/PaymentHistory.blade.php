                                ...
                                <div class="col-md-6 mb-12 mb-6">
                                    <div class="card card-stats card-payment-custom">
                                        ...
                                        <div class="history-button">
                                            <ul>
                                                <li><a href="{{route('nonSubscriber_payment_Receipt',$subscription_fees_submit->id)}}"> Recipt</a></li>
                                                <li><a href="{{route('nonSubscriber_payment_invoice',$subscription_fees_submit->id)}}"> Invoice</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @foreach($seminar_paid_subscriber as $seminar_paid_subscriber)
                                <div class="col-md-6 mb-12 mb-6">
                                    <div class="card card-stats card-payment-custom">
                                        ...
                                        <div class="history-button">
                                            <ul>
                                                <li><a href="{{route('nonSeminar_payment_Receipt',$seminar_paid_subscriber->seminar_id)}}"> Recipt</a></li>
                                                <li><a href="{{route('nonSeminar_payment_invoice',$seminar_paid_subscriber->seminar_id)}}"> Invoice</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
