...
@if(isset($subscriptionfee->userid) == Auth::id())
    @if((isset($subscriber->subscriber_id) == Auth::id() and ($subscriber->status =='active'))  and ($subscriptionfee->updated_at) > \Carbon\Carbon::now()->subDays(365)->toDateTimeString())
        <script>window.location = "{{ route('Subscriber_seminar_details',$seminar->id) }}";</script>
    @endif
@endif
                    ...
                    <div class="card-body">
                        <div class="col-lg-12 col-md-12">
                            <div class="seminar-workshop-box">
                                ...
                                <h4 class="seminar-fee"> Fee: {{$seminar->feegeneral}} Tk.</h4>
                                {!! $seminar->details !!}
                                <br>
                                @if($seminar->speaker1 !='')
                        ...
                        <div class="form-group col-lg-12 text-center">
                            ...
                            <form method="POST" action="{{route('non-shurjopay-submission')}}">
                                @csrf
                                ...
                                <input name="amount" type="hidden" value="{{$seminar->feegeneral}}" class="form-control">
