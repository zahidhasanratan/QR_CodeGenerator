...
@section('title')
    <title>Payment History | Non Subscriber | Seminar| Women & e-Commerce</title>
@endsection
@section('main')
                        ...
                        <div id="invoice">
                            ...
                            <div class="toolbar hidden-print">
                                <div class="text-right">
                                    <a target="_blank" href="{{ route('invoicepdfview',$subscription_fees_submit->seminar_id) }}" id="printInvoice" class="btn btn-info"><i class="fa fa-print"></i> Download/Print</a>
                                </div>
                                <hr>
                            </div>
                                    ...
                                    <main>
                                        <div class="row contacts">
                                            <div class="col invoice-to">
                                                ...
                                                <h2 class="to">{{$subscription_fees_submit->username}}</h2>
                                                <div class="email"><a href="mailto:{{$subscription_fees_submit->email}}">{{$subscription_fees_submit->email}}</a></div>
                                            </div>
                                            <div class="col invoice-details">
                                                <h1 class="invoice-id">Invoice:#SPF{{$subscription_fees_submit->seminar_id}}{{$id}}</h1>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="no">01</td>
                                                <td class="text-left"><h3>{{ \App\Models\Seminar::where(['id' => $subscription_fees_submit->seminar_id])->pluck('title')->first() }}</td>
                                                <td class="unit"></td>
                                                <td class="qty"></td>
