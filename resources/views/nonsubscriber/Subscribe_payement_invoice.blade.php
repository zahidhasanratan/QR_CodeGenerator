                            ...
                            <div id="invoice">
                                ...
                                <div class="toolbar hidden-print">
                                    <div class="text-right">
                                        <a target="_blank" href="{{ route('pdfview',$subscription_fees_submit->id) }}" id="printInvoice" class="btn btn-info"><i class="fa fa-print"></i> Download/Print</a>
                                    </div>
                                    <hr>
                                </div>
                                        ...
                                        <main>
                                            <div class="row contacts">
                                                ...
                                                <div class="col invoice-details">
                                                    <h1 class="invoice-id">Invoice:#SPF{{$subscription_fees_submit->id}}</h1>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td class="no">01</td>
                                                    <td class="text-left"><h3>Subscription Fee</td>
                                                    <td class="unit"></td>
                                                    <td class="qty"></td>
