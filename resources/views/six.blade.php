                        ...
                        <div class="form-row">
                            ...
                            <div class="wizard">
                                <div class="wizard-inner">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation" class="@if(($subscriber->step5)==1) active @else disabled @endif">
                            ...
                            <div class="tab-content" id="main_form">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step5">
                                    ...
                                    <form method="POST" action="{{route('fifth-form',$subscriber->subscriber_id)}}">
                                        @csrf
                                        <div class="row">
                                            <!--  Reference -->
                                            <input name="subscriber_id" type="hidden" value="{{{ Auth::user()->id}}}" class="form-control">
                                            <input name="step5" type="hidden" value="1" class="form-control">
                                            <fieldset class="col-lg-12 border border-primary p-3 mb-3">
                                ...
                                <div class="tab-pane @if(($subscriber->step5)==1) active @else @endif" role="tabpanel" id="step6">
                                    <!-- <h4 class="text-center">Step 6</h4> -->
                                    <form method="POST" action="{{route('sixth-form',$subscriber->subscriber_id)}}">
                                        @csrf
                                    <div class="row">
                                        <fieldset class="col-lg-12 border border-primary p-3 mb-3">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-6">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="defaultGroupExample2tt" name="step6" value="1" required>
