                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="wizard">
                                <div class="wizard-inner">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation" class="@if(($subscriber->step1)==1 and ($subscriber->step2)==1 and ($subscriber->step3)==1 and ($subscriber->step4)==1) active @else disabled @endif">
                            ...
                            <div class="tab-content" id="main_form">
                                ...
                                <div class="tab-pane @if(($subscriber->step1)==1 and ($subscriber->step2)==1 and ($subscriber->step3)==1 and ($subscriber->step4)==1) active @else @endif" role="tabpanel" id="step5">
