                            ...
                            <div id="invoice" class="effect2">
                                <div id="invoice-top">
                                    ...
                                    <div class="header-right">
                                        <div class="info" style="text-align:left">
                                            <h1>{{ \App\Models\SrShop::where('id',$order->shop_id)->first()->shopName }}</h1>
                                            <h2 style="font-size: 14px;">{{ \App\Models\SrShop::where('id',$order->shop_id)->first()->ownerName }}</h2> <!-- Assuming you want to show the authenticated user's name -->
                                            <h2 style="font-size: 14px;">{{ \App\Models\SrShop::where('id',$order->shop_id)->first()->Mobile }}</h2> <!-- User email -->
                                            <h2 style="font-size: 14px;">{{ \App\Models\SrShop::where('id',$order->shop_id)->first()->Adress }}</h2> <!-- Assuming you have a phone field in the user model -->
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="table">
                                        <table>
                                            ...
                                            <tr class="tabletitle" style="background: #012652; color: #fff;">
                                                ...
                                                <td class="payment">
                                                    <h2 style="color: #000;">{{ number_format($order->final_total, 2) }} Tk</h2> <!-- Final Total -->
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row" style="margin-top: 20px; padding-bottom: 15px;">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            <p>বিক্রিত পন্য ফেরত বা পরিবর্তন গ্রহণ যোগ্য নয়।
</p>
                                        </div>
                                    </div>
