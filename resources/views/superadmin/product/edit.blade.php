...
@section('title')
    <title>Product | Nurjahan Bazar</title>
@endsection
@section('main')
                        ...
                        @method('PUT') <!-- Use PUT or PATCH for updates -->
                            <fieldset class="col-lg-12 border p-3 mb-3">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-6">
                                        @if($product->photo)
                                            <img style="height: 80px; width: 100px;" src="{{ asset('uploads/products/' . $product->photo) }}">
                                        @endif
                                    </div>
                                ...
                                @foreach(\App\Models\Warehouse::all() as $warehouse)
                                    @php
                                        $stockIn = \App\Models\StockIn::where('productId', $product->id)
