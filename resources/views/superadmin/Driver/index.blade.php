...
@section('title')
    <title>Driver List | Nurjahan Bazar</title>
@endsection
@section('main')
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">All Driver List</h4>
                    </div>
                    ...
                    <div class="table-wrapper">
                        <div class="card-body">
                            ...
                            <div class="add-button text-right">
                                <a href="{{ route('driver.create') }}" class="btn btn-primary text-capitalize"><span>Add Driver</span></a>
                            </div>
                                    ...
                                    @foreach($driver as $key=>$list)
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <form id="delete-form-{{ $list->id }}" action="{{ route('driver.destroy', $list->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                ...
                                                <button type="button" onclick="window.location='{{ route('driver.edit', $list->id) }}'" rel="tooltip" class="btn btn-primary btn-link btn-sm" title="Edit list">
