...
@section('title')
    <title>Category List | Nurjahan Bazar</title>
@endsection
@section('main')
                    ...
                    <div class="table-wrapper">
                        <div class="card-body">
                            ...
                            <div class="add-button text-right">
                                <a href="{{ route('category.create') }}" class="btn btn-primary text-capitalize"><span>Add Category</span></a>
                            </div>
                                ...
                                <table id="warehouseTable" class="table table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <form id="delete-form-{{ $list->id }}" action="{{ route('category.destroy', $list->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            ...
                                            <button type="button" onclick="window.location='{{ route('category.edit', $list->id) }}'" rel="tooltip" class="btn btn-primary btn-link btn-sm" title="Edit list">
