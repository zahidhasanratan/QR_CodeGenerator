...
@section('title')
    <title>Country List | NRB World</title>
@endsection
@section('main')
                    ...
                    <div class="table-wrapper">
                        <div class="card-body">
                            ...
                            <div class="add-button text-right">
                                <a href="{{ route('unit.create') }}" class="btn btn-primary text-capitalize"><span>Add Country</span></a>
                            </div>
                                ...
                                <table id="warehouseTable" class="table table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <form id="delete-form-{{ $list->id }}" action="{{ route('unit.destroy', $list->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            ...
                                            <button type="button" onclick="window.location='{{ route('unit.edit', $list->id) }}'" rel="tooltip" class="btn btn-primary btn-link btn-sm" title="Edit list">
