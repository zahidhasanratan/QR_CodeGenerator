            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">Add SR</h4>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{route('sr.registration')}}" enctype="multipart/form-data">
                            @csrf
                            <fieldset class="col-lg-12 border p-3 mb-3">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-6">
                                        ...
                                        <span class="bmd-form-group"><input type="text" class="form-control" required="" name="srName" placeholder="Name"></span>
                                    </div>

                                    <div class="col-md-4 mb-6">
                                        <label for="validationServer013">Mobile Number </label>
                                        <span class="requierd-star"></span>
                                        <span class="bmd-form-group"><input type="text" class="form-control" required="" name="srMobile" placeholder="Mobile Number"></span>
                                    </div>

                                    <div class="col-md-4 mb-6">
                                        <label for="validationServer013">E-mail Address  </label>

                                        <span class="bmd-form-group"><input type="text" class="form-control" required="" name="srEmail" placeholder="E-mail Address"></span>
                                    </div>

                                    <div class="col-md-4 mb-6">
                                        <label for="validationServer013">Address</label>
                                        <span class="bmd-form-group"><input type="text" class="form-control" required="" name="srAddress" placeholder="Address"></span>
                                    </div>

                                    <div class="col-md-4 mb-6">
                                        <label for="validationServer013">NID Number</label>
                                        <span class="bmd-form-group"><input type="text" class="form-control" required="" name="srNid" placeholder="NID Number"></span>
                                    </div>
                                    <div class="col-md-4 mb-6">
                                    ...
                                    <div class="col-md-4 mb-6">
                                        ...
                                        <span class="bmd-form-group"><input type="text" class="form-control" required="" name="password" placeholder="******"></span>
                                    </div>
                                </div>
                            </fieldset>
