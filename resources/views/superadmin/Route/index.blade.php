...
@section('title')
    <title>Category List | NRB World</title>
@endsection
@section('main')
                    ...
                    <div class="table-wrapper">
                        <div class="card-body">
                            ...
                            <div class="add-button text-right">
                                <a href="{{ route('route.create') }}" class="btn btn-primary text-capitalize"><span>Add Category</span></a>
                            </div>
                                    ...
                                    @foreach($driver as $key=>$list)
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <form id="delete-form-{{ $list->id }}" action="{{ route('route.destroy', $list->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                ...
                                                <button type="button" onclick="window.location='{{ route('route.edit', $list->id) }}'" rel="tooltip" class="btn btn-primary btn-link btn-sm" title="Edit list">
