            ...
            <div class="login-form">
                <div class="main-div">
                    <div class="panel">
                        ...
                        <p>Check email or varify your OTP from mobile</p>
                    ...
                    {{--{{mt_rand(10, 1000000)}}--}}
                    <p class="alert alert">Or varify your OTP</p>
                    <form id="Login" method="POST" action="{{ route('verify.otp') }}">
                        @csrf
                ...
                <br>
                    <form id="Login" method="POST" action="{{ route('resend.otp') }}">
                        @csrf

                        <input type="hidden" name="mobile" value="{{$mobile}}">
                        <button type="submit"  class="btn btn-success" style="background-color: green">Resend OTP</button>
                    </form>
